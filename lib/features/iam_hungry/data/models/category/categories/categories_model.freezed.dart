...
class _$CategoriesModelTearOff {
  ...
  _CategoriesModel call({required List<CategoryModel> categories}) {
...
class _$_CategoriesModel implements _CategoriesModel {
  const _$_CategoriesModel({required this.categories});
...
abstract class _CategoriesModel implements CategoriesModel {
  const factory _CategoriesModel({required List<CategoryModel> categories}) =
      _$_CategoriesModel;
